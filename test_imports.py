...
modules_to_test = [
    ...
    ("core.updater", ["SelfUpdater"]),
    ("core.payload_manager", ["PayloadManager"]),
    ("core.stealth", ["StealthMode"]),
    ("core.stealth_pro", ["StealthPro"]),
    ("core.waf_bypass", ["WAFBypass"]),
    ("core.browser_emulator", ["BrowserEmulator"]),
    ("core.proxy_manager", ["ProxyManager"]),
    ("core.ai_scanner", ["AIScanner"]),
    # recon
...
print("=" * 70)
print("GOODS-DRAGON - MODULE IMPORT TEST SUITE")
print("=" * 70)
...
print("\n" + "=" * 70)
print(f"TOTAL: {len(success) + len(errors)} modules tested")
