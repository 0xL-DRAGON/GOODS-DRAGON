...
class HTMLReport:
    ...
    def generate_markdown(self):
        ...
        md = f"""# 🐉 GOODS-DRAGON - Security Assessment Report
...
"""
    ...
    def generate_html(self):
        ...
        <head>
            ...
            <title>GOODS-DRAGON - Security Report</title>
            <style>
                body {{ 
        ...
        html += f"""
                <div class="footer">
                    <p>Report generated by <strong>GOODS-DRAGON</strong> v1.0 | Developed by zeus (z4)</p>
