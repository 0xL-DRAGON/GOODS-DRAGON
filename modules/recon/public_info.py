...
class PublicInfo:
    ...
    def get_ip_info(self):
        ...
        try:
            resp = requests.get(f"http://ip-api.com/json/{self.target}?fields=status,message,country,countryCode,region,regionName,city,isp,org,as,query", timeout=10)
    ...
    def get_country_info(self, country_code):
        ...
        try:
            resp = requests.get(f"https://restcountries.com/v3.1/alpha/{country_code}", timeout=10)
            if resp.status_code == 200:
                data = resp.json()
    ...
    def get_domain_info(self):
        ...
        try:
            ...
            resp = requests.get(f"https://api.vercel.com/v2/domains/{self.target}", timeout=10)
            if resp.status_code == 200:
                data = resp.json()
    ...
    def get_phone_prefix(self, country_code):
        ...
        phone_prefixes = {
            'IR': '+98', 'US': '+1', 'GB': '+44', 'DE': '+49', 'FR': '+33',
            'IT': '+39', 'ES': '+34', 'PT': '+351', 'NL': '+31', 'BE': '+32',
            'CH': '+41', 'AT': '+43', 'SE': '+46', 'NO': '+47', 'DK': '+45',
            'FI': '+358', 'IE': '+353', 'NZ': '+64', 'AU': '+61', 'CA': '+1',
            'BR': '+55', 'MX': '+52', 'AR': '+54', 'CL': '+56', 'CO': '+57',
            'PE': '+51', 'VE': '+58', 'EG': '+20', 'ZA': '+27', 'NG': '+234',
            'KE': '+254', 'TN': '+216', 'MA': '+212', 'DZ': '+213', 'SA': '+966',
            'AE': '+971', 'TR': '+90', 'PK': '+92', 'IN': '+91', 'CN': '+86',
            'JP': '+81', 'KR': '+82', 'RU': '+7', 'UA': '+380', 'PL': '+48'
        }
