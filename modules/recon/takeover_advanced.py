...
class SubdomainTakeoverAdvanced:
    ...
    def run(self):
        ...
        common_subdomains = [
            "www", "mail", "ftp", "webmail", "smtp", "pop", "ns1", "cpanel",
            "admin", "blog", "dev", "vpn", "mysql", "api", "cdn", "git",
            "store", "help", "server", "test", "stage", "staging", "prod",
            "production", "backup", "assets", "media", "static", "images",
            "img", "video", "audio", "docs", "files", "uploads", "download",
            "app", "apps", "portal", "dashboard", "manage", "support",
            "docs", "wiki", "forum", "community", "status", "statuspage"
        ]
        ...
        log_success(f"Takeover scan completed. Found {len(self.vulnerable)} vulnerable subdomains.")
        return {
            "target": self.domain,
