...
class TechnologyDetector:
    def __init__(self, target, verbose=False):
        ...
        self.tech_patterns = {
            ...
            "Magento": [r"magento", r"Magento", r"skin/frontend", r"app/code/core"],
            "Laravel": [r"laravel", r"Laravel", r"vendor/laravel"],
            "React": [r"react", r"React", r"__REACT_DEVTOOLS_GLOBAL_HOOK__"],
            "Vue.js": [r"vue", r"Vue", r"__VUE__"],
            "Angular": [r"angular", r"Angular", r"ng-", r"ng-app"],
            "Bootstrap": [
                r"bootstrap",
                r"Bootstrap",
                r"cdn.jsdelivr.net/npm/bootstrap",
            ],
            "jQuery": [r"jquery", r"jQuery", r"cdnjs.cloudflare.com/ajax/libs/jquery"],
        }

    def fetch_page(self):
        try:
            resp = requests.get(
                self.target, timeout=10, headers={"User-Agent": "Mozilla/5.0"}
            )
