...
class JWTScanner:
    ...
    def __init__(self, target: str, verbose: bool = False):
        ...
        self.weak_secrets = [
            "secret", "password", "123456", "admin", "jwt", "key", "token",
            "abc123", "qwerty", "letmein", "monkey", "dragon", "baseball",
            "master", "sunshine", "iloveyou", "trustno1", "1234567",
            "password1", "12345678", "123456789", "1234567890", "admin123",
            "root123", "user123", "test123", "demo123", "dev123",
            "staging123", "prod123", "changeme", "welcome", "hello",
            "password123", "admin1234", "root1234", "user1234", "test1234",
            "secret123", "jwt123", "token123", "key123", "auth123"
        ]
    ...
    def _test_none_algorithm(self, token: str, header: Dict, payload: Dict) -> bool:
        ...
        if header.get('alg') != 'none':
            ...
            try:
                ...
                new_header['alg'] = 'none'
                new_header_encoded = base64.urlsafe_b64encode(
    ...
    def scan_token(self, token: str) -> Dict:
        ...
        sensitive_fields = ['password', 'secret', 'key', 'token', 'api_key', 'private', 'credit_card', 'cvv']
    ...
    def run(self) -> Dict:
        ...
        # Summary
        log_success(f"JWT scan completed. Found {len(tokens)} tokens, {len(self.vulnerabilities)} vulnerabilities.")
        return {
            "target": self.target,
            "scan_type": "jwt",
